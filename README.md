...
Click [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/PraCTES/MIT-PraCTES/master?urlpath=lab) to launch the code tutorial environment in your browser for both Python and Julia (no downloads required)!

To run the Matlab scripts, you will need to install Matlab (version > 2019b).

Information on how to run the Python and Julia notebooks on your personal machine (and how to set up your own Python / Julia environments for a scientific project) is coming soon.
